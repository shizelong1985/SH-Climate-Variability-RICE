...
elseif contour_alt_nr==2
    h1= contourm( double(HadISST_lat(146:167)),double(HadISST_lon),p_fdr_rej', [0.05],'--','ShowText','off',...
    'Linecolor',co_pa,'LineWidth', line_w_nr);
...
save(savefilename_c,'p_all','s_all','p_fdr_rej','HadISST_lat','HadISST_lon');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% for saving PSA pattern surfaces (step 1)-= one more step=-, not used 
