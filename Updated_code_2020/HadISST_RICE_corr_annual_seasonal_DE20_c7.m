%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DE HadISST_rice_corr_annual_seasonal_DE20_c7.m
...
if param_nr==2
 ...
 site='RICE';
  yr_s=1979;
  %yr_e=2009; %%%%%%%%% RICE 2009 %%% suppl. material
  yr_e=2011; 
  letter='d';
...
if yr_e==2009 % suppl. mat
    ...
    a1=axestext_c(1.08,+0.6, ['Correlation'] ,'rotation',-90,'FontSize',20, 'FontWeight', 'bold');    %050
...
export_fig('-pdf','-painters', '-depsc','-opengl', '-r190',savefilename_c); % EPS works  func needs ghostscript ,'-nocrop' 
